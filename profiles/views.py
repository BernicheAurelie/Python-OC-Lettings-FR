...
def index(request):
    """
    function to get all profiles list, return profiles/index template with all profiles objects in context
    """
...
def profile(request, username):
    """
    function to display details on a profile, selecting it by its user's username
    return profile/profile template with profile favorite_city and associated user's informations in context
